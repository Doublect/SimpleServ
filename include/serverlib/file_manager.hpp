...
#include <serverlib/utility/content_coding.hpp>
...
public: 
	...
	virtual utility::expected<DataT, ErrorT> get_file(const std::string& full_path) override;
};
...
class FileManager {
	typedef CacheFileFetcher<HTTPFileData, FileManagerException, DiskFileFetcher<HTTPFileData, FileManagerException>> Fetcher;
private:
	std::mutex file_access_mutex;
