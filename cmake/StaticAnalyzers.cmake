macro(simpleserv_enable_cppcheck WARNINGS_AS_ERRORS CPPCHECK_OPTIONS)
  ...
  if(CPPCHECK)
    ...
    if(NOT
       ...
       "")
			...
			# set(CMAKE_CXX_CPPCHECK ${CMAKE_CXX_CPPCHECK} --std=c++2b)
			# else()
...
macro(simpleserv_enable_clang_tidy target WARNINGS_AS_ERRORS)

  #find_program(CLANGTIDY clang-tidy)
  set(CLANGTIDY "/opt/clang/latest/bin/clang-tidy")
	if(CLANGTIDY)
    if(NOT
       ...
       "")
			if("${CLANG_TIDY_OPTIONS_DRIVER_MODE}" STREQUAL "cl")
				if(CMAKE_CXX_STANDARD EQUAL 23)
					set(CLANG_TIDY_OPTIONS ${CLANG_TIDY_OPTIONS} -extra-arg=/std:c++2b)
				else()
...
macro(simpleserv_enable_include_what_you_use)
